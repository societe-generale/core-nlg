...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3fbf7441e3dcce7a3d03f834e8dbaf2f242b658265eb958dc9bbea77f44dc642.js',function(){input.required=false;search();});}
